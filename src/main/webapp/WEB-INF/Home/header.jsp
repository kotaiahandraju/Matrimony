			...
			<ul class='main-nav'>
				...
				<li class="profiles">
					...
					<ul class="dropdown-menu">
						...
						<li class="launchingProfiles"><a href="${baseurl }/admin/launchingProfile">Launching Offer Profiles</a></li>
						<%-- <c:if test="${roleId1 == 1}"> 
	 ...
	 function removeNotification(id){
		 var checkstr =  confirm('Are you sure you want to delete?');
			...
			$.fn.makeMultipartRequest('POST', '${baseurl}/admin/removeNotificationInAdmin?id='+id, false, formData, false, 'text', function(data){
				...
				if(msg=="delete"){
					var count_str = $("#notification_cnt").html();
					var count_int = parseInt(count_str)-1;
					if(count_int<0){
						count_int = 0;
					}
					$("#notification_cnt").html(count_int);
