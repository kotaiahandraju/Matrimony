			...
			<div class="portlet" id="yw0">
				<div class="portlet-content w3-animate-zoom">
					...
					<form:form modelAttribute="educationForm" class="form-horizontal" role="form" id="education-form" action="addEducation" method="post">								
						...
						<div class="form-group">
							<label class="col-sm-4 control-label required"><spring:message code="label.educationName" text="default text" /> <span style="color:red;">*</span></label>
							<div class="col-sm-8">
...
function validate(id){
	if($('#name').val() ==  null || $('#name').val() == ""  || $('#name').val()=="undefined" ) {
	    ...
	    $("#nameError").text("Education cannot be blank.");
	}else{
		$("#nameError").text("");
	}
	}
...
//		$(window).scrollTop($('#addForm').offset().top);
 ...
 function deleteEducation(id){
		...
		$.fn.makeMultipartRequest('POST', 'deleteEducation', false,
