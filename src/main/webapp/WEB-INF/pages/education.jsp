...
<div class="container-fluid">
	...
	<div class="breadcrumbs">
		<ul>
			...
			<li>
				...
				<span style="color: #999;cursor: auto;">Education</span>
			</li>
		</ul>
	</div>
	<div class="row">
		<div class="col-lg-8">
			<div class="portlet" id="yw0">
				<div class="portlet-content w3-animate-zoom">
					...
					<form:form modelAttribute="educationForm" class="form-horizontal" role="form" id="education-form" action="addEducation" method="post">								
						<div class="row">
					  		<div class="col-md-12">
								<div class="form-group">
									<label class="col-sm-3 control-label required"><spring:message code="label.educationName" text="default text" /> <span class="impColor">*</span></label>
									<div class="col-sm-6">
										<form:hidden path="id"/>
										<form:input path="name" type="text" class="form-control onlyCharacters validate" autocomplete="off" placeholder="Enter Education" maxlength="255"/>
	...
	<div class="row">
		<div class="col-sm-12">
			<div class="box">
				<div class="box-title">
					<h3><i class="fa fa-table"></i> Education's List</h3>
				</div>
...
function deleteEducation(id){
	...
	if(checkstr == true){
		...
		$.fn.makeMultipartRequest('POST', 'deleteEducation', false, formData, false, 'text', function(data){
			var jsonobj = $.parseJSON(data);
// 			alert(jsonobj.message);
			if(jsonobj.message == "yes"){
				getDeleteMsg("alert-info","Education Deleted Successfully");
			}
