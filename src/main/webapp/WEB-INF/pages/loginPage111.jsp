			...
			<form:form commandName="loginForm" action="loginAction" method='post' class='form-validate' id="loginform">
				<div class="form-group">
					<div class="email controls">
						<form:input path="userName" autocomplete="off"  placeholder="Enter User Name" class='form-control validate'/>
				...
				<div class="form-group">
					...
					<form:password path="password" autocomplete="off" placeholder="Enter Password" class='form-control validate'/>
