	...
	<div class="breadcrumbs">
		<ul>
			...
			<li>
				...
				<span style="color: #999;cursor: auto;">Premium  Profiles</span>
			</li>
		</ul>
...
// 			var payment = "";
			...
			var moveToHidden = "<a data-toggle='tooltip' title='Move To Hidden' onclick='moveToHidden("+ orderObj.id+ ",\"premium\")'><i style='color: #3c8dbc;cursor: pointer;' class='fa fa-eye-slash'></i></a>"
  ...
  function profileStatusChange(id,statusId){
	  var checkstr = "";
		...
		var formData = new FormData();
	     ...
	     formData.append('statusName', "premium");
