					...
					<form:form modelAttribute="religionForm" class="form-horizontal" role="form" id="religion-form" action="addReligion" method="post">								
						<div class="form-group">
							<div class="col-sm-12">
								...
								<div class="errorMessage" id="Religion_invalid_em_" style="display:none"></div>
							</div>
					  	</div>
						<div class="form-group">
							...
							<div class="col-sm-8">
								<form:hidden path="id"/>
						  		<form:input path="name"  type="text" class="form-control onlyCharacters validate"  autocomplete="off" Placeholder="Enter Religion" maxlength="255"/>						
...
function validate(id){
	if($('#name').val() ==  null || $('#name').val() == ""  || $('#name').val()=="undefined" ) {
	    ...
	    $("#nameError").text("Religion cannot be blank.");
	}else{
		$("#nameError").text("");
	}
	}
 ...
 */
 ...
 function displayTable(listOrders) {
		...
		$.each(listOrders,function(i, orderObj) {
						var edit = "<a onclick='editReligion("+ orderObj.id+ ")'><i style='color: green;' class='fa fa-edit'></i></a>"
						var deleterow = "<a onclick='deleteReligion("+ orderObj.id+ ")'><i style='color: red;' class='fa fa-trash'></i></a>"
...
//		$(window).scrollTop($('#addForm').offset().top);
 ...
 function deleteReligion(id){
		...
		$.fn.makeMultipartRequest('POST', 'deleteReligion', false,
