	...
	<div class="container-fluid">
		...
		<div class="breadcrumbs">
			<ul>
				...
				<li>
					...
					<span style="color: #999;cursor: auto;">Religion</span>
				</li>
			</ul>
		</div>
		<div class="row">
			<div class="col-lg-8">
				<div class="portlet" id="yw0">
					<div class="portlet-content w3-animate-zoom">
						<!-- Religion Form Starts Here-->
						<form:form modelAttribute="religionForm" class="form-horizontal" role="form" id="religion-form" action="addReligion" method="post">								
							<div class="row">
					  			<div class="col-md-12">
									<div class="form-group">
										<label class="col-sm-3 control-label required"><spring:message code="label.religion" text="default text" /> <span class="impColor">*</span></label>
										<div class="col-sm-6">
											<form:hidden path="id"/>
											<form:input path="name" type="text" class="form-control onlyCharacters validate" placeholder="Enter Religion Name" autocomplete="off" maxlength="255"/>						
		...
		<div class="row">
			<div class="col-sm-12">
				<div class="box">
					<div class="box-title">
						<h3><i class="fa fa-table"></i> Religion's List</h3>
					</div>
...
function displayTable(listOrders) {
	...
	var tableHead = '<table class="table table-hover table-nomargin table-bordered dataTable dataTable-column_filter" data-column_filter_types="text,null">'
		+ '<thead><tr><th>Religion</th><th style="text-align: center;"></th></tr></thead><tbody></tbody></table>';
	$('#tableId').html(tableHead);
	serviceUnitArray = {};
	$.each(listOrders,function(i, orderObj) {
		var edit = "<a class='edit editIt' onclick='editReligion("+ orderObj.id+ ")'><i class='fa fa-pencil'></i></a>"
		var deleterow = "<a class='delete' onclick='deleteReligion("+ orderObj.id+ ")'><i class='fa fa-trash'></i></a>"
...
function deleteReligion(id){
	...
	if(checkstr == true){
		...
		$.fn.makeMultipartRequest('POST', 'deleteReligion', false, formData, false, 'text', function(data){
			var jsonobj = $.parseJSON(data);
// 			alert(jsonobj.message);
			if(jsonobj.message == "yes"){
				getDeleteMsg("alert-info","Religion Deleted Successfully");
			}
