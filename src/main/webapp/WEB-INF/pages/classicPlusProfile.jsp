	...
	<div class="breadcrumbs">
		<ul>
			...
			<li>
				...
				<span style="color: #999;cursor: auto;">Classic Plus  Profiles</span>
			</li>
		</ul>
 ...
 */
 ...
 function displayTable(listOrders) {
		...
		$.each(listOrders,function(i, orderObj) {
			...
			var moveToHidden = "<a data-toggle='tooltip' title='Move To Hidden' onclick='moveToHidden("+ orderObj.id+ ",\"classic_plus\")'><i style='color: #3c8dbc;cursor: pointer;' class='fa fa-eye-slash'></i></a>"
				        ...
				        buttons: [
						            {
						                extend: 'excelHtml5',
						                title: 'Classic Plus Profiles',
						                filename: 'Classic Plus Profiles'
						            },
						            {
						                extend: 'pdfHtml5',
//		 		                        messageTop : 'Classic Plus Profiles',
					                        title : 'Classic Plus Profiles',
...
//  	 var win = window.open(""+location+"/admin/CreateProfile/"+id+"");
  ...
  function profileStatusChange(id,statusId){
		...
		var formData = new FormData();
	     ...
	     formData.append('statusName', "classic_plus");
...
//	 		                        messageTop : 'Classic Plus Profiles',
 ...
 $(".classicPlusProfiles").addClass("active"); 
</script>
