	...
	<div class="container-fluid">
		...
		<div class="breadcrumbs">
			<ul>
				...
				<li>
					...
					<span style="color: #999;cursor: auto;">State</span>
				</li>
			</ul>
			...
			<div class="col-lg-8">
				<div class="portlet" id="yw0">
					<div class="portlet-content w3-animate-zoom">
						<!-- State Form Starts Here-->
						<form:form modelAttribute="stateForm" class="form-horizontal" role="form" id="sate-form" action="addState" method="post">								
							<div class="row">
					  			<div class="col-md-12">
									<div class="form-group">
										...
										<div class="col-sm-6">
											<form:hidden path="id"/>
											<form:input path="name"  type="text" class="form-control onlyCharacters validate" autocomplete="off" placeholder="Enter State" maxlength="255"/>						
		...
		<div class="row">
			<div class="col-sm-12">
				<div class="box">
					<div class="box-title">
						<h3><i class="fa fa-table"></i> States List</h3>
					</div>
...
function displayTable(listOrders) {
	...
	$.each(listOrders,function(i, orderObj) {
		var edit = "<a class='edit editIt' onclick='editState("+ orderObj.id+ ")'><i class='fa fa-pencil'></i></a>"
...
function editState(id) {
 ...
 function deleteState(id){
	...
	if(checkstr == true){
		...
		$.fn.makeMultipartRequest('POST', 'deleteState', false, formData, false, 'text', function(data){
			var jsonobj = $.parseJSON(data);
// 			alert(jsonobj.message);
			if(jsonobj.message == "yes"){
				getDeleteMsg("alert-info","State Deleted Successfully");
			}
