	...
	<div class="breadcrumbs">
		<ul>
			...
			<li>
				...
				<span style="color: #999;cursor: auto;">Hidden Profiles</span>
			</li>
		</ul>
				        ...
				        buttons: [
						            {
						                extend: 'excelHtml5',
						                title: 'Hidden Profiles',
						                filename: 'Hidden Profiles'
						            },
						            {
						                extend: 'pdfHtml5',
//		 		                        messageTop : 'Hidden Profiles',
					                        title : 'Hidden Profiles',
 ...
 function editProfile(id) {
	 var location = $("#loc").val();
 	 window.location.href =location+"/admin/CreateProfile/"+id+"/HiddenProfilesHome";
	 if (win) {
