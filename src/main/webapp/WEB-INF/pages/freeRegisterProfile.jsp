	...
	<div class="breadcrumbs">
		<ul>
			...
			<li>
				...
				<span style="color: #999;cursor: auto;">Free Register Profiles</span>
			</li>
		</ul>
				        ...
				        buttons: [
						            {
						                extend: 'excelHtml5',
						                title: 'Free Register Profiles',
						                filename: 'Free Register Profiles'
						            },
						            {
						                extend: 'pdfHtml5',
  ...
  function profileStatusChange(id,statusId){
	  var checkstr = "";
		...
		var formData = new FormData();
	     ...
	     formData.append('statusName', "free");
