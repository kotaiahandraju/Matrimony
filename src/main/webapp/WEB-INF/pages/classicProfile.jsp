	...
	<div class="breadcrumbs">
		<ul>
			...
			<li>
				...
				<span style="color: #999;cursor: auto;">Classic  Profiles</span>
			</li>
		</ul>
 ...
 */
 ...
 function displayTable(listOrders) {
		...
		var tableHead = '<table class="table table-hover table-nomargin table-bordered dataTable dataTable-column_filter" data-column_filter_types="text,text,text,text,text,null">'
			+ '<thead><tr><th>Created On</th><th>Username</th><th>First Name</th><th>Last Name</th><th>Email</th><th>Mobile</th><th>Age</th><th>Caste</th><th>Package</th><th></th></tr></thead><tbody></tbody></table>';
...
// 			var payment = "";
			...
			var moveToHidden = "<a data-toggle='tooltip' title='Move To Hidden' onclick='moveToHidden("+ orderObj.id+ ",\"classic\")'><i style='color: #3c8dbc;cursor: pointer;' class='fa fa-eye-slash'></i></a>"
  ...
  function profileStatusChange(id,statusId){
	  var checkstr = "";
		...
		var formData = new FormData();
	     ...
	     formData.append('statusName', "classic");
...
//	 		                        messageTop : 'Classic Profiles',
 ...
 $(".classicProfiles").addClass("active"); 
</script>
