...
function getFilteredStatesMultiSelect(id) {
		if ($("#" + id).val() == null || $('#' + id).val() == ""
			...
			var formData = new FormData();
			formData.append('country_ids', countryIds);
			$.fn.makeMultipartRequest('POST','${baseurl }/admin/getFilteredStates',false,formData,false,'text',function(data) {
								var jsonobj = $.parseJSON(data);
								var statesList = jsonobj.states_list;
								$("#rState").empty();
								/* $("#rState")
...
function getFilteredCitiesMultiSelect(id) {
		if ($("#" + id).val() == null || $('#' + id).val() == ""
			...
			$.fn.makeMultipartRequest('POST','${baseurl }/admin/getFilteredCities',false,formData,false,'text',function(data) {
								var jsonobj = $.parseJSON(data);
								...
								var selected_values = "${userBean.rCity}";
							    if(selected_values == "" || selected_values==null){
							    	$("#rCity").select2({
