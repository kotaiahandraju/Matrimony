	...
	<div class="container-fluid">
			...
			<div class="col-lg-8">
				<div class="portlet" id="yw0">
					<div class="portlet-content w3-animate-zoom">
						<!-- Star Form Starts Here-->
						<form:form modelAttribute="starForm" class="form-horizontal" role="form" id="star-form" action="addStar" method="post">								
							<div class="row">
					  			<div class="col-md-12">
									<div class="form-group">
										<label class="col-sm-3 control-label required"><spring:message code="label.star" text="default text" /> <span class="impColor">*</span></label>
										<div class="col-sm-6">
											<form:hidden path="id"/>
		...
		<div class="row">
			<div class="col-sm-12">
				<div class="box">
					<div class="box-title">
						<h3><i class="fa fa-table"></i> Star's List</h3>
					</div>
...
function displayTable(listOrders) {
	...
	var tableHead = '<table  class="table table-hover table-nomargin table-bordered dataTable dataTable-column_filter" data-column_filter_types="text,null">'
		+ '<thead><tr><th>Star</th><th style="text-align: center;"></th></tr></thead><tbody></tbody></table>';
	$('#tableId').html(tableHead);
	serviceUnitArray = {};
	$.each(listOrders,function(i, orderObj) {
		var edit = "<a class='edit editIt' onclick='editStar("+ orderObj.id+ ")'><i class='fa fa-pencil'></i></a>"
		var deleterow = "<a class='delete' onclick='deleteStar("+ orderObj.id+ ")'><i class='fa fa-trash'></i></a>"
...
function deleteStar(id){
	...
	if(checkstr == true){
		...
		$.fn.makeMultipartRequest('POST', 'deleteStar', false, formData, false, 'text', function(data){
			var jsonobj = $.parseJSON(data);
// 			alert(jsonobj.message);
			if(jsonobj.message == "yes"){
				getDeleteMsg("alert-info","Star Deleted Successfully");
			}
