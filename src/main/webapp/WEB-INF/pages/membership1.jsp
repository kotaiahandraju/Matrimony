...
.midcontnet { border-bottom:12px solid #F1F1F2; padding-bottom:40px; }
  ...
  <body>
   ...
   <div class="col-md-12">
   <h3>Membership Plans</h3><br>

   </div>
   
   <div class="col-md-6">
     <img src="images/membership.jpg" border="0" usemap="#Map" class="img-responsive">
     <map name="Map">
       <area shape="rect" coords="190,509,345,554" href="profileView">
     </map>
   </div>
   
   <div class="col-md-6">
     <img src="images/benifits.jpg" class="img-responsive"></div>
    ...
    <footer class="footer" id="footer"><!-- Section id-->
            	<div class="col-md-6 col-sm-6">
                	<div class="logo-footer">
                    	<img src="images/logo-b.png" alt="" class="img-responsive" />
                    </div>
                </div>
                <div class="col-md-6 col-sm-6">
