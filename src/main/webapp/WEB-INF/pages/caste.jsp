...
function displayTable(listOrders) {
	...
	$.each(listOrders,function(i, orderObj) {
		var edit = "<a class='edit editIt' onclick='editCaste("+ orderObj.id+ ")'><i class='fa fa-pencil'></i></a>"
		var deleterow = "<a class='delete' onclick='deleteCaste("+ orderObj.id+ ")'><i class='fa fa-trash'></i></a>"
...
function deleteCaste(id){
	...
	if(checkstr == true){
		...
		$.fn.makeMultipartRequest('POST', 'deleteCaste', false, formData, false, 'text', function(data){
			var jsonobj = $.parseJSON(data);
// 			alert(jsonobj.message);
			if(jsonobj.message == "yes"){
				getDeleteMsg("alert-info","Caste Deleted Successfully");
			}
