...
.midcontnet { border-bottom:12px solid #F1F1F2; padding-bottom:40px; }
  ...
  <body>
   ...
   <div class="col-md-12">
   <h3>Thanks for Registering. Now lets build your profile</h3><br>
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="textinput">You live in*</label>  
  <div class="col-md-6">
   <select id="selectbasic" name="selectbasic" class="form-control">
...
<div class="form-group">
  <label class="col-md-4 control-label" for="textinput">Your Marital Status*</label>  
  <div class="col-md-6">
  <select id="selectbasic" name="selectbasic" class="form-control ">
...
<div class="form-group">
  <label class="col-md-4 control-label" for="textinput">Your Community*</label>  
  <div class="col-md-6">
  <select id="selectbasic" name="selectbasic" class="form-control ">
      <option value="1">Married</option>
      <option value="2">Option two</option>
...
<div class="form-group">
  ...
  <div class="col-md-6">
  <select id="selectbasic" name="selectbasic" class="form-control ">
      <option value="1">Nakshatram</option>
      <option value="2">Option two</option>
    </select>
  </div>
</div>
