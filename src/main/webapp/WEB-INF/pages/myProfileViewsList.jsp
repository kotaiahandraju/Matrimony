...
<div class="products">
  ...
  <div>
		...
		<section id="tab1" class="tab-content active">
			<div id="profiles_div">
				...
				<div class="panel panel-success">
					<div class="panel-heading" id="tbl_header">Members who viewed your profile </div>
		...
		<section id="tab2" class="tab-content hide">
			<div>
				Show members that I've viewed their profile.<br>
				Don't show members that I've viewed their profile.
...
function displayMatches(listOrders) {
	...
	if(listOrders==""){
		...
		$(str).appendTo("#profiles_div");
		
		//var tblRow = '<div>No members found.</div>';
...
function paginationSetup(total_items_count) {
	$('#altLists').asPaginator(total_items_count, {
        ...
        onChange: function(page) {
      	...
      	formData.append("request_from","myprofileviews");
