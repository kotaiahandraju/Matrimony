	...
	<div class="breadcrumbs">
		<ul>
			...
			<li>
				...
				<span style="color: #999;cursor: auto;">Aarna Premium  Profiles</span>
			</li>
		</ul>
 ...
 */
 ...
 function displayTable(listOrders) {
		...
		$.each(listOrders,function(i, orderObj) {
			...
			var moveToHidden = "<a data-toggle='tooltip' title='Move To Hidden' onclick='moveToHidden("+ orderObj.id+ ",\"aarna_premium\")'><i style='color: #3c8dbc;cursor: pointer;' class='fa fa-eye-slash'></i></a>"
				        ...
				        buttons: [
						            {
						                extend: 'excelHtml5',
						                title: 'Aarna Premium Profiles',
						                filename: 'Aarna Premium Profiles'
						            },
						            {
						                extend: 'pdfHtml5',
//		 		                        messageTop : 'Aarna Premium Profiles',
					                        title : 'Aarna Premium Profiles',
...
//  	 var win = window.open(""+location+"/admin/CreateProfile/"+id+"");
  ...
  function profileStatusChange(id,statusId){
		...
		var formData = new FormData();
	     ...
	     formData.append('statusName', "aarna_premium");
...
//	 		                        messageTop : 'Aarna Premium Profiles',
 ...
 $(".aarnaPremiumProfiles").addClass("active"); 
</script>
