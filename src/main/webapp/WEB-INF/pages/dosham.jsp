	...
	<div class="container-fluid">
		...
		<div class="breadcrumbs">
			<ul>
				...
				<li>
					...
					<span style="color: #999;cursor: auto;">Dosham</span>
				</li>
			</ul>
			...
			<div class="col-lg-8">
				<div class="portlet" id="yw0">
					<div class="portlet-content w3-animate-zoom">
						<!-- Dosham Form Starts Here-->
						<form:form modelAttribute="doshamForm" class="form-horizontal" role="form" id="dosham-form" action="addDosham" method="post">								
						  	<div class="row">
					  			<div class="col-md-12">
									<div class="form-group">
										<label class="col-sm-3 control-label required"><spring:message code="label.dosham" text="Dosham" /> <span class="impColor">*</span></label>
										<div class="col-sm-6">
											<form:hidden path="id"/>
											<form:input path="name" type="text" class="form-control onlyCharacters validate" placeholder="Enter Dosham" autocomplete="off"  maxlength="255"/>						
		...
		<div class="row">
			<div class="col-sm-12">
				<div class="box">
					<div class="box-title">
						<h3><i class="fa fa-table"></i> Dosham's List</h3>
					</div>
...
function displayTable(listOrders) {
	...
	$.each(listOrders,function(i, orderObj) {
		var edit = "<a class='edit editIt' onclick='editDosham("+ orderObj.id+ ")'><i class='fa fa-pencil'></i></a>"
		var deleterow = "<a class='delete' onclick='deleteDosham("+ orderObj.id+ ")'><i class='fa fa-trash'></i></a>"
...
function deleteDosham(id){
	var checkstr =  confirm('Are you sure you want to Delete?');
	if(checkstr == true){
		var formData = new FormData();
	    formData.append('id', id);
		$.fn.makeMultipartRequest('POST', 'deleteDosham', false, formData, false, 'text', function(data){
			var jsonobj = $.parseJSON(data);
// 			alert(jsonobj.message);
			if(jsonobj.message == "yes"){
				getDeleteMsg("alert-info","Dosham Deleted Successfully");
			}
