				...
				<div class="portlet-content w3-animate-zoom">
					<form:form modelAttribute="doshamForm" class="form-horizontal" role="form" id="dosham-form" action="addDosham" method="post">								
						...
						<div class="form-group">
							<label class="col-sm-4 control-label required"><spring:message code="label.state" text="Dosham" /><span style="color:red;">*</span></label>
							<div class="col-sm-8">
							<form:hidden path="id"/>
...
function validate(id){
	if($('#name').val() ==  null || $('#name').val() == ""  || $('#name').val()=="undefined" ) {
	    ...
	    $("#nameError").text("Dosham cannot be blank.");
	}else{
		$("#nameError").text("");
	}
	}
 ...
 */
 ...
 function displayTable(listOrders) {
		...
		$.each(listOrders,function(i, orderObj) {
							var edit = "<a onclick='editDosham("+ orderObj.id+ ")'><i style='color: green;' class='fa fa-edit'></i></a>"
							var deleterow = "<a onclick='deleteDosham("+ orderObj.id+ ")'><i style='color: red;' class='fa fa-trash'></i></a>"
...
//		$(window).scrollTop($('#addForm').offset().top);
 ...
 function deleteDosham(id){
		...
		$.fn.makeMultipartRequest('POST', 'deleteDosham', false,
