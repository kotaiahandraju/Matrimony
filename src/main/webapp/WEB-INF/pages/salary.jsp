	...
	<div class="breadcrumbs">
		<ul>
			...
			<li>
				...
				<span style="color: #999;cursor: auto;">YearlySalary</span>
			</li>
		</ul>
				...
				<div class="portlet-content w3-animate-zoom">
					<form:form modelAttribute="salaryForm" class="form-horizontal" role="form" id="salary-form" action="addSalary" method="post">								
						...
						<div class="form-group">
							<label class="col-sm-4 control-label required"><spring:message code="label.state" text=" Salary" /><span style="color:red;">*</span></label>
							<div class="col-sm-8">
							<form:hidden path="id"/>
...
function validate(id){
	if($('#name').val() ==  null || $('#name').val() == ""  || $('#name').val()=="undefined" ) {
	    ...
	    $("#nameError").text("Yearly Salary cannot be blank.");
	}else{
		$("#nameError").text("");
	}
	}
 ...
 */
 ...
 function displayTable(listOrders) {
		...
		$.each(listOrders,function(i, orderObj) {
							var edit = "<a onclick='editSalary("+ orderObj.id+ ")'><i style='color: green;' class='fa fa-edit'></i></a>"
							var deleterow = "<a onclick='deleteSalary("+ orderObj.id+ ")'><i style='color: red;' class='fa fa-trash'></i></a>"
